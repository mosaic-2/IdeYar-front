...
const CodeVerification = () => {
    ...
    return (_jsx(Box, { display: "flex", justifyContent: "center", alignItems: "center", height: "100vh", m: 2, children: loading ? _jsx(CircularProgress, {}) : _jsx("h1", { children: "Code Verification" }) }));
};
