...
const projects = [
    ...
    },
    {
        ...
        description: "پشتیبانی از پروژه‌های تکنولوژیک پیشرو که آینده را شکل می‌دهند.",
        imageUrl: "https://via.placeholder.com/400x200",
        amountPaid: 7500000,
        amountGoal: 15000000,
    },
...
const ProjectsSlider = () => {
    ...
    return (_jsx(Slider, { ...settings, children: projects.map((project, index) => (_jsx(Box, { sx: {
                display: "flex",
            ...
            }, children: _jsx(ProjectCard, { ...project }) }, index))) }));
};
